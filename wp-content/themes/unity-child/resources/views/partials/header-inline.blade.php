...
<header class="banner header-inline" role="banner" style="background-color: {{ $header_color }}">
  <nav class="nav-primary" role="navigation">
    <div class="navbar flex space-between" data-text-color="{{ $text_color }}">
      @php
        if (!empty($logo_width)) {
      ...
      @if (has_nav_menu('primary_navigation'))
        ...
        <div class="navbar-menu flex space-between">
          {!! wp_nav_menu(['theme_location' => 'primary_navigation', 'container' => FALSE, 'menu_class' => 'flex flex-bottom space-between']) !!}
